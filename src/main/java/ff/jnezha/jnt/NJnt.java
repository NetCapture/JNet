...
/**
 * Deprecated v3 facade retained for artifacts that already exposed NJnt.
 *
 * @author sanbo
 * @version 3.0.0
...
public class NJnt {
    ...
    public static class XX {
        ...
        public XX url(String url) {
            ...
            newXX.headers = this.headers == null ? null : new LinkedHashMap<>(this.headers);
            return newXX;
        }
        ...
        public String exec() {
            if (url == null || url.trim().isEmpty()) {
                throw new IllegalStateException("URL must be set before executing the request");
            }
