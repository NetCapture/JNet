...
/** Gitee repository-content API compatibility facade. */
public class GiteeHelper {
    private static final GitContentsClient CLIENT = GitContentsClient.gitee();
    private static volatile String token = System.getenv("GITEE_TOKEN");
    ...
    public static class ShaInfo {
        ...
        public ShaInfo(String name, String path, String sha, long size, String url, String htmlUrl,
                String gitUrl, String downloadUrl, String type, Object links,
