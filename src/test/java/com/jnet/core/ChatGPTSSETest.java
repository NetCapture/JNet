...
public class ChatGPTSSETest {
    ...
    public static void main(String[] args) {
        System.out.println("=== ChatGPT SSE 流式测试 ===\n");

        // 检查 API key
        if (API_KEY.equals("YOUR_API_KEY_HERE") || API_KEY.isEmpty()) {
            System.out.println("❌ 请先配置 API_KEY！");
            System.out.println("   编辑 " + ChatGPTSSETest.class.getName() + " 类");
    ...
    private static void sendSSERequest(String userMessage) throws Exception {
        ...
        try {
            // 使用 ProcessBuilder 执行 curl 命令（绕过 Java HTTP 客户端问题）
    ...
    /**
     * 构建 curl 命令（字符串形式，已废弃，使用 buildCurlCommandArray 代替）
     */
